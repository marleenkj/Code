...
layout = html.Div([
    ...
    dbc.Stack([
        ...
        dbc.Col([
            dcc.Loading(children=dcc.Graph(id = 'plot-map', style={"width": "100%", "height": "600px"}))
        ], width = 4, align = 'center'),
        dbc.Col([
            #instruction_graph,
            dcc.Loading(children=dcc.Graph(id='plot-bar-shipments', style={"width": "100%", "height": "600px"})),
            collapse_button
