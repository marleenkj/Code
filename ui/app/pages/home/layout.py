...
card1 = dbc.Card(
    [
        ...
        dbc.CardBody(
            [
                html.H6("Individual Client Analysis", className="card-title", style={"height": "2rem"}),
                html.P(
                    """
                ...
                dbc.CardFooter(dbc.CardLink("Go to analysis", href="http://127.0.0.1:5000/Client_analysis", className = "card-text text-muted")),
            ]
        ),
...
card2 = dbc.Card(
    [
        ...
        dbc.CardBody(
            [
                html.H6("Transport Plan Routing Analysis", className="card-title", style={"height": "2rem"}),
                html.P(
                    """
                ...
                dbc.CardFooter(dbc.CardLink("Go to analysis", href="http://127.0.0.1:5000/Routing_analysis", className = "card-text text-muted")),
            ]
        ),
    ], className="w-100 mb-5", color = "light"
)
...
card3 = dbc.Card(
    [
        ...
        dbc.CardBody(
            [
                html.H6("Railroad Freight Systems Analysis", className="card-title", style={"height": "2rem"}),
                html.P(
                    """
                ...
                dbc.CardFooter(dbc.CardLink("Go to analysis", href="http://127.0.0.1:5000/System_analysis", className = "card-text text-muted")),
            ]
        ),
    ], className="w-100 mb-5", color = "light"
)
...
card0 = dbc.Card(
    [
        ...
        dbc.CardBody(
            [
                html.H6("Summary of results", className="card-title", style={"height": "2rem"}),
                html.P(
                    """
                ...
                dbc.CardFooter(dbc.CardLink("Go to overview", href="http://127.0.0.1:5000/Dataset", className = "card-text text-muted")),
            ]
        ),
    ], className="w-100 mb-5", color = "light"
) 
