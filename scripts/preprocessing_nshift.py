import pandas as pd
from src.preprocessing import data_preprocessing_nshift
...
if __name__ == '__main__':
    ...
    df = pd.read_csv(f'{project_path}/raw/Extract_nShift_Örebro_2022.csv', delimiter = ';', decimal = '.')
    ...
    df = data_preprocessing_nshift(df, dict_names)
